...
log "Account SID: $($sidstr)" 

$tmp = [System.IO.Path]::GetTempFileName()

log "Export current Local Security Policy" 
...
if( $currentSetting -notlike "*$($sidstr)*" ) {
	log "Modify Setting ""Logon as a Service""" 
...
"@
	...
	log "Import new settings to Local Security Policy"
	...
	log "NO ACTIONS REQUIRED! Account already in ""Logon as a Service""" 
}
